...
sudo wget -O "$SCRIPT_DIR/SpeedTest-X_Updata_Apache.sh" https://raw.githubusercontent.com/zz22558822/SpeedTest-X_install/refs/heads/main/SpeedTest-X_Updata_Apache.sh
